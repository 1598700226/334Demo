...
public class PointCloudManager : MonoBehaviour {
	...
	void loadScene(){
		...
		if(!Directory.Exists (Application.dataPath + "/Resources/PointCloudMeshes/" + filename)){
			#if UNITY_EDITOR
            AssetDatabase.CreateFolder ("Assets/Resources/PointCloudMeshes", filename);
			#endif
            loadPointCloud();
		} else if (forceReload){
			#if UNITY_EDITOR
            FileUtil.DeleteFileOrDirectory(Application.dataPath + "/Resources/PointCloudMeshes/" + filename);
